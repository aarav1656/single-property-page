  ...
  return (
    <section className="min-h-screen w-full py-16 bg-white flex items-center justify-center">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <h2 className="font-bold  text-center text-xl uppercase tracking-wider mb-2 text-gray-500">AMENITIES</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
          ...
          <div className="bg-yellow-400 p-4 sm:p-6 flex flex-col justify-center items-center text-center w-full">
