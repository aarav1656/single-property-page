      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="aspect-square bg-gray-200">
            <img src="https://www.nozone.it/dynamic/img/render-interni.jpg" alt="Luxury interior" className="w-full h-full object-cover" />
          </div>
          ...
          <div className="aspect-square bg-gray-200">
            <img src="https://image.slidesdocs.com/responsive-images/background/luxurious-3d-rendering-of-a-hotel-suite-bedroom-with-lavish-amenities-including-tv-and-chandelier-powerpoint-background_a950fdc736__960_540.jpg" alt="Luxury bedroom" className="w-full h-full object-cover" />
          </div>
          ...
          <div className="aspect-square bg-gray-200">
            <img src="https://static.vecteezy.com/system/resources/thumbnails/026/577/159/small_2x/modern-bedroom-interior-design-in-apartment-or-house-with-furniture-luxury-bedroom-scandinavian-concept-by-ai-generated-free-photo.jpg" alt="Modern bedroom" className="w-full h-full object-cover" />
          </div>
          <div className="bg-yellow-400 p-4 sm:p-6 flex flex-col justify-center items-center text-center">
